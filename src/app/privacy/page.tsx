...
export const metadata: Metadata = {
  title: "Privacy Policy · Pub Quiz Hub",
  description: "What Pub Quiz Hub stores, who processes it, and how to have it deleted.",
};
  ...
  return (
    <LegalPage title="Privacy Policy">
      <LegalSection id="who-we-are" title="Who we are">
        <LegalText>
          Pub Quiz Hub is operated by Yanshuf Studio, Israel. For anything about your data, write to{" "}
