 ...
 * robots.txt blocks is the one sitemap mistake Search Console actually
 * complains about, so the two files are meant to be read together and
 * `sitemap.test.ts` checks they still agree.
 *
